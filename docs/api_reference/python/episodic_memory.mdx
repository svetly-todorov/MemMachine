...
description: "The `EpisodicMemory` class provides a high-level interface for creating and managing episodic memory."
icon: "people-group"
---
## Initialization
...
<a id="memmachine.episodic_memory"></a>

### memmachine.episodic\_memory
