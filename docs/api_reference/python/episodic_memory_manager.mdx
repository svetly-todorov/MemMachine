...
The `EpisodicMemoryManager` provides methods for managing and querying your episodic memory. It's the central class for performing actions like searching for specific episodes.
