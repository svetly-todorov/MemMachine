...
<Columns cols={3}>
  <Card
    title="Default Agent"
    icon="globe"
    href="http://https://github.com/MemMachine/MemMachine/tree/main/examples/README.txt"
  >
...
Be sure to check out the [README file](https://github.com/MemMachine/MemMachine/tree/main/examples/README.txt) in the examples folder for more details on how make the most of our Example Agents.
