...
For information on the table structures utilized by MemMachine in neo4j, please check out the Long-Term memory portion of our [Memory Types](./memory_types.mdx) section.
...
For information on the table structure utilized by MemMachine in PostgreSQL, please check out the Profile Memory portion of our [Memory Types](./memory_types.mdx) section.
