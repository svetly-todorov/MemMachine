...
| `model_name`                  | Yes       | "gpt-4o-mini"     | The name of the model to use (e.g., `gpt-4o-mini`).               |
...
| `region`                      | No        | N/A               | The AWS region for the Bedrock model (e.g., `us-west-2`).         |
| `aws_access_key_id`           | No        | N/A               | The AWS access key ID for Bedrock authentication.                 |
| `aws_secret_access_key`       | No        | N/A               | The AWS secret access key for Bedrock authentication.             |
...
| `aws_embedder_id`                    | No        | N/A           | Tag should you choose to use AWS Bedrock for your Embedder.  |
| `<ID>.name`                          | No        | 'amazon-bedrock' | The vendor name of your embedder.                         |
| `<ID>.region`                        | No        | N/A           | The AWS region for the Bedrock embedder (e.g., `us-west-2`). |
...
| `<ID>.model_id`                      | No        | N/A           | The Bedrock model ID to use for embeddings.                  |
| `<ID>.similarity_metric`             | No        | "cosine"      | | The similarity metric to use for embedding comparisons (e.g., `cosine`, `euclidean`). |
