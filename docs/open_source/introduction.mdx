...
MemMachine works as an intelligent memory layer on top of a user's Agentic LLM experience.  It gathers input via Python APIs in a Memory Instance, then determines if that input is profile, short-term and/or long-term:  
 - **Profile memory** consists of information specific to the user and their experience.  It is consumed by the Profile Engine and discussed in depth within our [Personalized Memory](../personal_memory/) section.
 ...
 - **Future memory** a placeholder for memory elements that have yet to be developed.
