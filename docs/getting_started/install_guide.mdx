...
<Note>> if you are using a CPU only installation, be sure to comment out cross-encoder lines (46, 51-53) with a '#' or remove those lines from your file, as you will not be able to use the cross-encoder reranker in that environment.</Note>
