#!/usr/bin/env bash
# Build memmachine-client package

echo "Building memmachine-client package..."
...
if ! cp pyproject-client.toml pyproject.toml; then
    echo "ERROR: Failed to copy pyproject-client.toml to pyproject.toml"
